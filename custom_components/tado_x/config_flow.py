...
class TadoXOptionsFlow(OptionsFlow):
    ...
    async def async_step_init(
        ...
        if user_input is not None:
            ...
            enable_heat_pump = user_input.get(CONF_ENABLE_HEAT_PUMP, has_auto_assist)
            enable_energy_iq = user_input.get(CONF_ENABLE_ENERGY_IQ, has_auto_assist)
            ...
            new_data = {
                **self.config_entry.data,
                ...
                CONF_ENABLE_ENERGY_IQ: enable_energy_iq,
            }
            ...
            if self.config_entry.entry_id in self.hass.data.get(DOMAIN, {}):
                ...
                coordinator.enable_heat_pump = enable_heat_pump
                coordinator.enable_energy_iq = enable_energy_iq
        ...
        current_enable_heat_pump = self.config_entry.data.get(CONF_ENABLE_HEAT_PUMP, default_features)
        current_enable_energy_iq = self.config_entry.data.get(CONF_ENABLE_ENERGY_IQ, default_features)
            ...
            data_schema=vol.Schema(
                {
                    ...
                    vol.Required(
                        CONF_ENABLE_HEAT_PUMP,
                        default=current_enable_heat_pump,
                    ): bool,
                    vol.Required(
                        CONF_ENABLE_ENERGY_IQ,
                        default=current_enable_energy_iq,
                    ): bool,
                }
            ),
        )
